...
import com.testing.springpractice.userauthservice.Configurations.JwtUtils;
import com.testing.springpractice.userauthservice.DataTranseferObjects.AuthDataTransferObjects.LoginRequest;
import com.testing.springpractice.userauthservice.DataTranseferObjects.AuthDataTransferObjects.RegisterRequest;
import com.testing.springpractice.userauthservice.DataTranseferObjects.AuthDataTransferObjects.ResetPasswordRequest;
import com.testing.springpractice.userauthservice.DataTranseferObjects.AuthDataTransferObjects.VerifyEmailRequest;
...
public class AuthService {
    ...
    public String login(@Valid LoginRequest request) {
        ...
        return jwtUtils.getToken(request.getUsername(), user.getVerified(), user.getId());
    }
